...
## Task 2: CHAT_API + CHAT_REQUEST_HANDLER completion
...
## Task 3: Cross-processor doorbell assault (Phase 5 item pulled early — MANDATORY)
...
## Task 4: SQLITE_CHAT_STORE + CHAT_SCHEMA.migrate + equivalence assault
...
## Task 5: Configuration + server app
...
## Task 6: Ops — the door and DNS actually run
...
## Task 8: Web streaming + peer address
...
## Task 9: Client transport and shell
