...
feature -- Access
	...
	Product: STRING_32 = "0.2.0"
			-- Keep in step with installer\SimpleChat.iss #define AppVersion.

	Built_on: STRING_32 = "2026-09-03"

	Libraries: STRING_32 = "simple_widgets 0.7.1, simple_console 1.2.0, simple_ai_client (UTF-8 fix), simple_winhttp 0.1.1, simple_process 1.0.1, simple_encryption 2.1.1, simple_shell 1.9.3"
