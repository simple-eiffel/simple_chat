...
feature {NONE} -- Initialization
	...
	make
		...
		do
			...
			run_test (agent (create {CLIENT_ASSAULT}).test_admin_create_user_sends_the_three_fields_and_reads_the_member_back, "admin_create_user_sends_the_three_fields_and_reads_the_member_back")
			run_test (agent (create {CLIENT_ASSAULT}).test_admin_create_user_carries_the_rooms_refusal, "admin_create_user_carries_the_rooms_refusal")
			run_test (agent (create {CLIENT_ASSAULT}).test_admin_users_reads_the_rooms_accounts_people_and_bots, "admin_users_reads_the_rooms_accounts_people_and_bots")
			run_test (agent (create {CLIENT_ASSAULT}).test_admin_reset_password_posts_under_the_users_id_and_carries_a_refusal, "admin_reset_password_posts_under_the_users_id_and_carries_a_refusal")
			...
			run_test (agent (create {OPS_ASSAULT}).test_room_probe_believes_only_a_health_reply, "room_probe_believes_only_a_health_reply")
			run_test (agent (create {OPS_ASSAULT}).test_room_probe_over_winhttp_finds_no_room_on_a_silent_port, "room_probe_over_winhttp_finds_no_room_on_a_silent_port")
